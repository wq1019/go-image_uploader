...
func (ip *nosImageProxyURL) Generate(hashValue string, opt ...Option) string {
...
func (ip *nosImageProxyURL) buildOptionsStr(opts *options) string {
	opt := strings.Builder{}
	if opts.width != 0 {
...
func NewNosImageProxyURL(imageproxyHost, baseURL, bucketName string, omitBaseURL bool, h2sn Hash2StorageName) URL {
	if h2sn == nil {
		h2sn = Hash2StorageNameFunc(DefaultHash2StorageNameFunc)
	}
	return &nosImageProxyURL{
